...
namespace chargelab {
    ...
    public:
        ...
        onRequestStartTransactionReq(const ocpp2_0::RequestStartTransactionRequest &req) override;
        ...
        onRequestStopTransactionReq(const ocpp2_0::RequestStopTransactionRequest &req) override;
