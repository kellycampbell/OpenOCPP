...
namespace chargelab {
    namespace {
        constexpr char const* kMaskedValue = "****";
    }
    ...
    ConfigurationModule::onGetBaseReportReq(const ocpp2_0::GetBaseReportRequest &request) {
        if (ocpp2_0_pending_base_report_.has_value()) {
            return ocpp2_0::GetBaseReportResponse {ocpp2_0::GenericDeviceModelStatusEnumType::kRejected};
        }

        switch (request.reportBase) {
            case ocpp2_0::ReportBaseEnumType::kValueNotFoundInEnum:
            case ocpp2_0::ReportBaseEnumType::kSummaryInventory:
                return ocpp2_0::GetBaseReportResponse {ocpp2_0::GenericDeviceModelStatusEnumType::kNotSupported};
        ...
        return ocpp2_0::GetBaseReportResponse {ocpp2_0::GenericDeviceModelStatusEnumType::kAccepted};
    }
