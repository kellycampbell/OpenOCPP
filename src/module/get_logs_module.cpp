...
namespace chargelab {
    namespace {
        constexpr int kTargetDroppedLogMessageBytes = 1024;
        constexpr int kMaxRetainedLogMessagesBytes = 2*1024;
        constexpr int kUploadStepMaxTimeMillis = 100;
        constexpr int kPriorityLogStatusNotification = 100;
        constexpr int kQueueReportFrequencySeconds = 10;
        constexpr std::uint64_t kOperationGroupId = 0xDB0A571F9D6E2A10ull;
    }
